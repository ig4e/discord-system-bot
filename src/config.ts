...
export const config = {
	botId: '1187865840364826724',
	probotId: '282859044593598464',
	owners: ['885627298743738380', '713835453891215442', '744280854188130414'] as string[], // الهيكون معاهم صلاحيات فل تحكم فل بوت زي تغير الصورة و الاسم و الكلام ده
	transferTo: ['744280854188130414'], //الشخص الهتخلي الناس تحولو الكردت فشراء الرتب
	icons: { //تقدر تغير الايكونات عادي و تحط اي اموجي انت عايزة 
		claim: '🛄',
		warning: '⚠️',
		info: 'ℹ️',
		error: '❌',
		...
		category: [
			{
				...
				categoryId: '1167190185314881537', // ايدي الكاتيجوري الهتفتح فيها التكت
				closedCategoryId: '1167190185314881537' // ايدي الكاتيجوري الهتقفل فيها التكت
			},
			{
				id: 'report',
				label: 'تبليغ',
